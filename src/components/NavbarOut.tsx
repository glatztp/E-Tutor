    ...
    <div>
      ...
      <div className="bg-white flex justify-between items-center px-6 py-3 border border-b-gray-200 pb-5">
        ...
        <div className="flex items-center gap-4 text-gray-700">
          ...
          <Link to="/signup" className="border px-4 py-2 text-orange-500 bg-orange-100 hover:bg-orange-200 transition-all duration-200">
            Create Account
          </Link>
          <Link to="/login" className="px-4 py-2 text-white bg-orange-500 hover:bg-orange-600 transition-all duration-200">
            Sign In
          </Link>
        </div>
      </div>
